...
<body onload="studentsTable()">
    ...
    <div class="departments_box">
        <div class="card">
            <h2>Batch Upload</h2>
            <form action="/department_side/login_using_msO365/student_batch_upload.php" method="POST"
    ...
    <script type="text/javascript">
        ...
        // Use jQuery to hide the second row of the table
        // $(document).ready(function(){
        //     $('#tableStudents tbody tr:eq(0)').hide();
        // });
    </script>
    ...
    <div class="departments_box">
        <div class="card">
            ...
            if ($department === "Registrar") {
                echo '<button type="button" class="btn" id="exportDepartmentBtn">Export Registrar</button> ';
                echo '<button type="button" class="btn" id="exportAllBtn">Export All</button> ';
                echo '<button type="button" class="btn" id="archiveAllBtn">Archive All</button>';
            } else {
                echo '<button type="button" class="btn" id="exportDepartmentBtn">Export Data</button>';
            }
            ?>
            ...
            <script>
                $(document).ready(function() {
                    $('#exportAllBtn').click(function() {
                        window.location.href = 'php_page_contents/export_all_trail.php';
                        console.log('Export All Trail');
                    });
                });

                $(document).ready(function() {
                    $('#exportDepartmentBtn').click(function() {
                        window.location.href = 'php_page_contents/export_department_trail.php';
                        console.log('Export Department Trail');
                    });
                });

                $(document).ready(function() {
                    $("#archiveAllBtn").on("click", function() {
                        alertify.confirm("Confirm Archiving", "Are you sure you want to archive all students records?",
                            function () { // If the student clicks "OK"
                                // Send an AJAX request to Archive students
                                archiveRecords();
                                // alertify.message("Archived");
                            },
                            function () { // If the student clicks "Cancel"
                                alertify.message("Archiving of Students Cancelled.");
                                console.log("Archiving of Students Cancelled.");
                            }
                        );
                    });
                    ...
                    function archiveRecords() {
                        $.ajax({
                            url: 'php_page_contents/archive.php',
                            type: 'POST',
                            dataType: 'json',
                            ...
                            error: function(error) {
                                alertify.error("Error archiving records.");
            ...
            <h2>Students</h2>
            <label>In this module, the department can add, edit, delete a student.</label>
                ...
                <table id="tableStudents" class="flat-table">
                    ...
                    <tbody>
                        ...
                        if ($department == 'Registrar') {
                            ...
                            $clearedTable = mysqli_query($db, "SELECT * FROM tbl_cleared WHERE department = '$department' ORDER BY last_name ASC ");
                        }
                        ...
                        <tr>
                            ...
                            <td style="color: <?php echo ($row['status'] == 'OK' && $row['remarks'] == 'Cleared') ? 'green' : 'black'; ?>">
                                <?php echo $row['status'] ?>
                            </td>
                            <td>
                            ...
                            <td style="color: <?php echo ($row['remarks'] == 'Cleared') ? 'green' : 'black'; ?>">
                            ...
                            <td>
                                ...
                                ?> -->
                                        ...
                                        <button type="button" class="student-delete-btn delete_btn" data-id="<?php echo $row['id']; ?>" onclick="console.log('Archive Button')">Archive</button>
                                <!-- <?php // } ?> -->
                            </td>
                        </tr>
                        <?php
        ...
        <div class="modal-content">
            ...
            <form id="add-student-form">
                ...
                <div class="form_column">
                    ...
                    <!--// TODO: section dropdown dependent on course.-->
                    <div class="departments_box">
                        <div class="form_column">
        ...
        <div class="modal-content">
            ...
            <form id="edit-student-form">
                ...
                <div class="form_column">
                    ...
                    <input type="hidden" id="editSchoolYear" name="schoolYear">
                        ...
                        <script>
                            $(document).ready(function(){
                                $('#editCourse').on('change', function(){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'get_sections.php', // Replace with the actual path to your server-side script
                                        data: {course_code: courseCode},
                                        success: function(response){
                                            // Update the sections dropdown with the new options
                                            $('#editSection').html(response);
                                        }
                                    });
                                });
                            });
    ...
    <script>
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        if (record) {
                            ...
                            $('#editSchoolYear').val(record.school_year);
        ...
        function updateRecord() {
            ...
            if (window.record) {
                ...
                var schoolYear = $('#editSchoolYear').val();
