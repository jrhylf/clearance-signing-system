...
<table id="myTable" class="flat-table">
    ...
    <tbody>
        ...
        if (mysqli_num_rows($studentsTable) > 0) {
            ...
            -->
                    <td style="color: <?php echo ($row['status'] == 'OK') ? 'green' : 'red'; ?>">
                        <?php echo $row['status']; ?>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php echo $row['course'] . ' ' . $row['section']; ?>
                    </td>
                    <td>
                        <?php echo $row['email']; ?>
                    </td>
                    <!-- // TODO REPLACE "TYPE" DEPENDING ON ACTIVITY(e.g. Active, Alumni, Returnee) -->
                    <td style="color: <?php echo ($row['type'] == 'Active') ? 'green' : 'red'; ?>">
                        <?php echo $row['type']; ?>
                    </td>
                    ...
                    <td>
                        ...
                        <button type="button" class="student-delete-btn delete_btn" data-id="<?php echo $row['id']; ?>" onclick="console.log('Archived Button')">Archived</button>
                    </td>
                </tr>
                <?php
            }
