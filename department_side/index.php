...
<body>
    ...
    <main>
        ...
        <form action="index.php" method="POST" autocomplete="off">
            <label class="access_level">DEPARTMENT LOGIN</label>
            <div class="container">
                ...
                <div class="login">
                    ...
                    <input type="text" id="username" class="username" placeholder="Username" name="user">
                    <br>
                    <input type="password" id="password-input" class="password" placeholder="Password" name="pass">
                    <br>
