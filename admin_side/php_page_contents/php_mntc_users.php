...
<head>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var editContactInput = document.getElementById('editContact');
            ...
            var editMiddlenameInput = document.getElementById('editMiddlename');
            ...
            // Restrict only numbers in middlename and allow special characters
            middlenameInput.addEventListener('input', function () {
                this.value = this.value.replace(/[0-9]/g, ''); // Restrict numbers
            });
        ...
        <div class="modal-content">
            ...
            <form id="add-users-form">
                ...
                <div class="departments_box">
                    ...
                    <div class="column">
                        <label for="gender">Gender:</label><span class="optional"> (Optional)</span><br>
                        <select class="dp_dropdown" id="gender" name="gender">
                    ...
                    <div class="column">
                        <label for="contact">Contact:</label><span class="optional"> (Optional)</span><br>
                        <input type="text" class="dp_name" id="contact" name="contact"><br><br>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (add_success) {
                                    ...
                                    $('#firstname').val('');
                                    $('#middlename').val('');
                                    $('#gender').val('Prefer not to say');
                                    $('#department_dd').val('No Department');
                                    $('#position').val('No Position');
                                    $('#username').val('');
                                    $('#password').val('');
                                    $('#email').val('');
                                    $('#contact').val('');
        ...
        <div class="modal-content">
            ...
            <form id="edit-users-form">
                ...
                <div class="departments_box">
                    ...
                    <div class="column">
                        <label for="editGender">Gender:</label><span class="optional"> (Optional)</span><br>
                        <select class="dp_dropdown" id="editGender" name="gender">
                            <option>Prefer not to say</option>
                            <option>Male</option>
                            <option>Female</option>
                        </select><br><br>
                    ...
                    <div class="column">
                        <label for="editContact">Contact:</label><span class="optional"> (Optional)</span><br>
                        <input type="text" class="dp_name" id="editContact" name="contact"><br><br>
                    ...
                    <div class="column">
                        ...
                        <?php $departments = mysqli_query($db, "SELECT department_name FROM tbl_departments"); ?>
                        <select class="dp_dropdown" id="editDepartment_dd" name="department_assigned" required>
                            <option>No Department</option>
                            <?php while ($row = mysqli_fetch_array($departments)) { ?>
                                <option>
                                    <?php echo $row['department_name'] ?>
