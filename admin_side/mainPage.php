...
<head>
    ...
    <title>ADMIN | Clearance Signing System</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <!-- <link href='/CAPSTONE_CSS/boxicons-2.1.4/css/boxicons.css' rel='stylesheet'> -->
...
<body>
    <header>
        ...
        <div class="blue">
            <span class="header_text">WELCOME <span id="user-name"><?php echo $_SESSION['position']; ?></span></span>
        </div>
    </header>
                ...
                <ul>
                    ...
                    <li class="dropdown <?php echo isCurrentPage('maintenance') ? 'active' : ''; ?>">
                        ...
                        <ul class="dropdown_menu">
                            <li><a href="mainPage.php?page=php_mntc_departments"><i class='bx bx-minus'><span> Departments</span></i></a></li>
                            <li><a href="mainPage.php?page=php_mntc_users"><i class='bx bx-minus'><span> Users</span></i></a></li>
                            <li><a href="mainPage.php?page=php_mntc_students"><i class='bx bx-minus'><span> Students</span></i></a></li>
                            <li><a href="mainPage.php?page=php_mntc_course_section"><i class='bx bx-minus'><span> Course & Section</span></i></a></li>
                            <li><a href="mainPage.php?page=php_mntc_academic"><i class='bx bx-minus'><span> Academic</span></i></a></li>
                            <li><a href="mainPage.php?page=php_mntc_activity"><i class='bx bx-minus'><span> Activity</span></i></a></li>
                            <li><a href="mainPage.php?page=php_mntc_announcement"><i class='bx bx-minus'><span> Announcement</span></i></a></li>
                            <li><a href="mainPage.php?page=php_mntc_admin"><i class='bx bx-minus'><span> Administrators</span></i></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="<?php echo isCurrentPage('logout') ? 'active' : ''; ?>">
                ...
                <div class="main_php_contents">
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        if ($page == 'dashboard') {
                            ...
                            include 'php_page_contents/php_departments.php';
                        } else if ($page == 'maintenance') {
                            include 'php_page_contents/php_maintenance.php';
                        } else if ($page == 'php_mntc_departments') {           // START NG MAINTENANCE PAGES
                            include 'php_page_contents/php_mntc_departments.php';
                        } else if ($page == 'php_mntc_users') {
                            include 'php_page_contents/php_mntc_users.php';
                        } else if ($page == 'php_mntc_course_section') {
                            include 'php_page_contents/php_mntc_course_section.php';
                        } else if ($page == 'php_mntc_students') {
                            include 'php_page_contents/php_mntc_students.php';
                        } else if ($page == 'php_mntc_academic') {
                            include 'php_page_contents/php_mntc_academic.php';
                        } else if ($page == 'php_mntc_activity') {
                            include 'php_page_contents/php_mntc_activity.php';
                        } else if ($page == 'php_mntc_admin') {
                            include 'php_page_contents/php_mntc_admin.php';
